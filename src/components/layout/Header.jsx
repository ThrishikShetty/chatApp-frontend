...
// const NewGroupDailog = React.lazy(() => import("../specific/NewGroup"));
// const NotificationDailog = React.lazy(() =>
...
//   const { noticationCount} = useSelector((state) => state.chat);
...
//       )}
//       {isNotification && (
//         <Suspense fallback={<Backdrop open />}>          <NotificationDailog />
//         </Suspense>
//       )}
//       {isNewGroup && (
//         <Suspense fallback={<Backdrop open />}>          <NewGroupDailog />
//         </Suspense>
//       )}
//     </>
//   );
